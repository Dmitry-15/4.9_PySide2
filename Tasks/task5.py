...
people = {
    "Дмитрий": "+7 988 258-42-72",
    "Иван": "+7 905 475-75-42",
    "Николай": "+7 909 123-45-65",
}
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.button1 = QPushButton("Дмитрий")
        self.button1.setCheckable(True)
        self.button2 = QPushButton("Иван")
        self.button2.setCheckable(True)
        self.button3 = QPushButton("Николай")
